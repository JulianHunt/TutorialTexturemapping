...
ModelClass::ModelClass(ColorVertexType* vertices, int numvertices, unsigned long* indices, int numindices, D3D_PRIMITIVE_TOPOLOGY topology)
{
...
ModelClass::ModelClass(TextureVertexType* vertices, int numvertices, unsigned long* indices, int numindices, D3D_PRIMITIVE_TOPOLOGY topology)
{
